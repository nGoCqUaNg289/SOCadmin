            ...
            <thead>
              <tr>
                ...
                <tr v-for="(item, index) in productColor" :key="index">
                    ...
                    <td><input type="number" oninput="this.value = Math.abs(this.value)" min="1" v-model="item.quantity" style="width: 100%;border: none;border-bottom: 1px dashed;"/></td>
                ...
                <tr>
                  <td class="text-center" colspan="3">
                    <button style="border: none; color: red; background-color: white" @click="createNewColor()">
                      <i class="cil-plus"></i>
                    </button>
                  </td>
                </tr>  
